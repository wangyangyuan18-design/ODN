...
def _plan(designs,dc,edge_layer,spacing):
    ...
    # Dependency order: previous edge must be known before current edge.
    ...
    for e in final_edges:
        ...
        # Continuity beats a fresh route-rank choice: it is the main anti-crossing rule.
        ...
        for u in uses:
            ...
            # Straight Pole Edge continuation cannot change lane. A real conflict is left for validation.
